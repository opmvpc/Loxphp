...
class TokenizerTest extends TestCase
{
    ...
    public function testUnexpectedChar()
    {
        ...
        $this->expectOutputString("[31mERROR at line 1 in  : Unexpected character \"~\".". PHP_EOL ."[0m");
    }
...
EOT;
    ...
    public function testNeverEndingMultiLinesComment()
    {
        ...
        $this->assertEquals('T_EOF  ', $tokens[1]->__toString());
        $this->assertTrue(Loxphp::$hadError);
        $this->expectOutputString("[31mERROR at line 1 in  : Unterminated comment.". PHP_EOL ."[0m");
    }
    ...
    public function testNeverEndingMultiLinesComment2()
    {
        ...
        $this->assertEquals('T_EOF  ', $tokens[0]->__toString());
        $this->assertTrue(Loxphp::$hadError);
        $this->expectOutputString("[31mERROR at line 3 in  : Unterminated comment.". PHP_EOL ."[0m");
    }
...
EOT;
    ...
    public function testUnclosedString()
    {
        ...
        $this->assertEquals('T_EOF  ', $tokens[0]->__toString());
        $this->assertTrue(Loxphp::$hadError);
        $this->expectOutputString("[31mERROR at line 1 in  : Unterminated string.". PHP_EOL ."[0m");
    }
